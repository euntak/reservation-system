requirejs.config({
    ...
    paths:{
        ...
        'templates/simpleTicket': 'templates/myreservation/simple-ticket'
    }
});

requirejs(['jquery', 'hbs!templates/simpleTicket'],

function ($, simpleTicketTempl) {
